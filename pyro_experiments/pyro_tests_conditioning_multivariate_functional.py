...
a named sample site but sampling a subset of the variables at a sample site and
introducing the observed value as a variable instead of having it fixed.
