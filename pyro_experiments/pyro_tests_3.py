...
Data is generated by a Normal distribution featuring unknown mean and standard
deviation. The standard deviation is random with a chi-2 prior distribution.
Constraints are added to make the inference more challenging.
...
def model(data=None):
    ...
    sigma=pyro.sample("sigma", dist.Chi2(3))
